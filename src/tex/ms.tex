...
\begin{figure*}[ht!]
    \centering
    % \resizebox{\textwidth}{!}{\includegraphics*{figure5.pdf}}
...
\begin{figure}
    \centering
    % \resizebox{\columnwidth}{!}{\includegraphics*{figure8.pdf}}
...
\begin{figure}
    \centering
    % \resizebox{\columnwidth}{!}{\includegraphics*{figure8.pdf}}
    \includegraphics[width=\columnwidth]{msd_blocking.pdf}
...
\begin{figure}
    \centering
    % \resizebox{\columnwidth}{!}{\includegraphics*{figure9.pdf}}
...
\begin{figure}
    \centering
    % \resizebox{\columnwidth}{!}{\includegraphics*{figure10.pdf}}
