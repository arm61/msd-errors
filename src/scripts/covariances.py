...
gs = gridspec.GridSpec(3, 3, figure=fig, wspace=0.6, hspace=0.6)
...
titles.append(r"a")
axes[-1].set_title("Numerical", y=1.0)
...
axes[-1].set_yticks([0, int(length / 2), length])
titles.append(r"b")
axes[-1].set_title("Analytical", y=1.0)
...
axes[-1].set_yticks([0, int(length / 2), length])
titles.append(r"c")
axes[-1].set_title("Estimated", y=1.0)
...
x_correction = [32.5, 32.5, 32.5, 13.5, 13.5, 13.5]
